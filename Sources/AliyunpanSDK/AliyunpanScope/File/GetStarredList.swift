...
extension AliyunpanFileScope {
	...
	public class GetStarredList: AliyunpanCommand {
		...
		public struct Request: Codable {
            ...
            public init(drive_id: String, limit: Int? = nil, marker: String? = nil, order_by: String? = nil, video_thumbnail_time: Int? = nil, video_thumbnail_width: Int? = nil, image_thumbnail_width: Int? = nil, order_direction: String? = nil, type: String? = nil) {
