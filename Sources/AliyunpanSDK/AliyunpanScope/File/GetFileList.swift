...
extension AliyunpanFileScope {
	...
	public class GetFileList: AliyunpanCommand {
		...
		public struct Request: Codable {
			...
			/// DESC ASC
			public var order_direction: String?
            ...
            public init(drive_id: String, parent_file_id: String, limit: Int? = nil, marker: String? = nil, order_by: String? = nil, order_direction: String? = nil, category: String? = nil, type: String? = nil, video_thumbnail_time: Int? = nil, video_thumbnail_width: Int? = nil, image_thumbnail_width: Int? = nil, fields: String? = nil) {
